<template>
    ...
    <q-card class="no-padding" style="width:100%">
        ...
        <div class="q-pa-sm q-gutter-sm">
            ...
            <q-btn v-if="loggedIn" :style="buttonStyle" rounded icon="edit" label="edit"  @click="edit"/>
            <q-btn v-if="loggedIn" :style="buttonStyle" rounded icon="flag" label="Report"  @click="report"/>
            <q-btn v-if="loggedIn?teamMember:false" color="red" rounded icon="delete" label="Delete"  @click="deleteItemAction"/>
    ...
    <div >
        ...
        <q-card-section class="q-pt-none">
            <p class="text-bold cp-h2">Most recent experiences</p>
                <div v-if="singleItemData.comments" class="q-pl-none">
                    <div v-for="(comment, commentId, index) in singleItemData.comments" :key="index" class="row">
        ...
        <q-card-actions>
            <comment-marker v-if="loggedIn"
            :itemKey="singleItemData.itemKey"
            />
        </q-card-actions>
...
export default {
    ...
    components:{
		'comment-marker': require('components/Shared/Modals/CommentMarker.vue').default,
