  ...
  <q-card class="no-padding">
    <form @submit.prevent="saveEditFormMethod()">
      ...
      <q-card-section class="q-gutter-y-md">
        ...
        >
        <q-banner
          v-if="refsextra[refKey].description"
          rounded
        ...
        <div v-for="(item, index) in refsextra[refKey].items" :key="index">
          ...
          <div v-else class="q-my-md">
            ...
            <q-banner
              ...
              rounded
              class="bg-green-2 text-green-10 q-mb-sm"
              ><b>What to write in this section?</b><br />{{
                item.description
              }}</q-banner
            >
...
export default {
  ...
  components: {
    "list-description": require("components/Country/Modals/ListDescription.vue")
      .default,
  },
