      ...
      <div style="height: 75%;">
          ...
          <q-page-container>
            <q-page class="q-pa-sm">
              <q-tab-panels v-model="edit_tab" animated>
                <q-tab-panel
                  name="edit_about"
                  class="q-gutter-y-md q-gutter-y-md"
                >
                  ...
                  <div class="row q-gutter-sm">
                    <q-btn
                      ...
                      icon="edit"
                      label="change email"
                      @click="editEmailMethod"
                    />
                    <q-btn
                      :style="buttonStyle"
                      icon="edit"
                      label="change password"
                      @click="editPasswordMethod"
                    />
                    <q-btn
                      color="red-3"
                      icon="delete_forever"
                  ...
                  <q-input
                    ...
                    type="textarea"
                    autogrow
                    v-model="userData.countries_cycled"
                ...
                >
                  <q-select
                    filled
                    outlined
                    v-model="userData.hosting.status"
                    :options="options"
                    label="Status"
                    use-input
                    behavior="menu"
                  ...
                  <q-input
                    filled
                    autogrow
                    v-model="userData.hosting.description"
                    label="Describe what guests can expect"
                    type="textarea"
                  />
                  <q-input
                    filled
                    v-model="userData.hosting.max_guests"
                    label="Max. guests"
                  />
                  <q-toggle
                    v-model="userData.hosting.pets_allowed"
                    label="Pets allowed?"
                  />
                  <q-toggle
                    v-model="userData.hosting.bike_inside"
                    label="Bike can be stored inside?"
                  />
                </q-tab-panel>
              </q-tab-panels>
            </q-page>
        ...
        <q-dialog v-model="editBackgroundForm">
          <edit-background
            :type="type"
            :userData="userData"
            @close="editBackgroundForm = false"
          />
        </q-dialog>
    ...
    editEmailMethod() {
      this.$q
        .dialog({
          title: "Confirm",
          message:
            "Are you sure you want to change your email? You will be logged out, so make sure you saved your last changes.",
          ok: {
            push: true,
            label: "Yes",
          },
    ...
    deleteAccount() {
      this.$q
        .dialog({
          title: "Confirm",
          message:
            "Are you sure you want to delete your account permanently? All your data will be deleted.",
          ok: {
            push: true,
            label: "Yes",
          },
