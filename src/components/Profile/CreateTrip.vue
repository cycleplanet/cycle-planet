<template>
      ...
      <div class="q-pa-md q-gutter-y-sm">
        <q-input label="title*" filled v-model="newTrip.title" :rules="[val => !!val || 'Field is required']"/>

        <q-input filled label="summary*" v-model="newTrip.summary" type="textarea" :rules="[val => !!val || 'Field is required']"/>

        <q-select outlined filled v-model="newTrip.countries" :options="countryKeys" label="Start country" class="q-mb-md bg-white" :rules="[val => !!val || 'Field is required']"/>
