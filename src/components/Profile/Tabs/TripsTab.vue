<template>
  <div class="q-gutter-y-md">
    ...
    <div class="bg-grey-4 newcard relative-position cursor-pointer" @click="createTripDialog=true" v-if="myProfile&&!userData.trips">
    ...
    <div v-for="(trip, tripKey) in userData.trips" :key="tripKey" class="no-padding">

      <q-card  class="cursor-pointer no-padding q-future-card-style" @click="clickedTrip(tripKey)" >
        <div></div>
       
        <div style="height:100%">
          <map-trip :userIdProp="userId" :tripKeyProp="tripKey" :showParts="false" />
        </div>
