      ...
      <q-tab-panel name="current" class="bg-grey-2">
        ...
        >
          <div
            ...
            :style="isWebApp ? 'width:500px' : 'width:300px'"
          >
            Host requests received ({{ Object.keys(requestsReceived).length }})
          </div>

          <q-list bordered separator v-if="requestsReceived">
            <q-item
              v-for="(bool, requestkey) in requestsReceived"
              :key="requestkey"
              class="no-padding bg-white"
            >
          ...
          <q-list
            v-for="(bool, requestkey) in requestsNeedFeedback"
            :key="requestkey"
          >
            <request-need-feedback
...
export default {
  ...
  components: {
    ...
    "request-received": require("components/Profile/Requests/Received.vue")
      .default,
    "request-need-feedback": require("components/Profile/Requests/NeedFeedback.vue")
      .default,
  },
