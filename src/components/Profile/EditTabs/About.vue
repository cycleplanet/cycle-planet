  ...
  <div>
    ...
    >
      <q-btn
        ...
        rounded
        icon="add_a_photo"
        @click="editBackgroundDialog = true"
      />
    </div>
      ...
      <div class="row q-mt-md">
        <div class="col-xs-12 col-sm-12 col-md-6 col q-mb-md">
          <div style="width: 94px;" class="q-mb-sm">
            ...
            <div
              ...
              class="underline-hover text-blue-10 justify-center row"
            >
              Edit image
            </div>
          </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-6">
          ...
          >
              ...
              <l-circle
                :lat-lng="
                  userData.coordinates_approx
                    ? userData.coordinates_approx
                    : [
                        userData.coordinates.lat + Math.random() * 0.01,
                        userData.coordinates.lng + Math.random() * 0.01,
                      ]
                "
                :radius="1100"
              />
            ...
            <l-marker
              v-if="userData.coordinates && !userData.coordinates_hide"
              :lat-lng.sync="userData.coordinates"
              :draggable="true"
            >
              <l-icon
          ...
          <getlocation-button />
          <q-toggle
            v-model="userData.coordinates_hide"
    ...
    <div class="q-pa-sm">
      ...
      <q-card-section class="q-pt-none no-margin no-padding">
                ...
                <q-item bordered separator>
                  ...
                  <q-item-section side>
                    <q-btn
                      ...
                      dense
                      icon="cancel"
                      @click="deleteGear(gearKey, itemKey, childitemKey)"
                    />
                  </q-item-section>
                </q-item>
        ...
        <q-btn
          ...
          class="q-mt-md buttontheme1"
        />
      </q-card-section>
    </div>
    <q-dialog
      :maximized="isWebApp ? false : true"
      v-model="editBackgroundDialog"
    >
...
export default {
  ...
  components: {
    ...
    LFeatureGroup,
    LCircle,
    "edit-backgroundpicture": require("components/Profile/EditBackgroundImage.vue")
      .default,
    "edit-profilepicture": require("components/Profile/EditProfileImage.vue")
      .default,
