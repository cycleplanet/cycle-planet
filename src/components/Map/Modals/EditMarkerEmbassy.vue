  ...
  <q-card class="no-padding" style="width: 100%;">
    ...
    <form @submit.prevent="submitMarker">
      <q-card-section class="q-gutter-y-md">
        <q-banner dense rounded class="bg-green-2 text-green-10" v-if="canEdit"
          >You can edit the <b>title</b> and <b>coordinates</b> because you
          {{
            admin
              ? "are an admin."
              : roleEditor
        ...
        <q-banner
          ...
          v-if="!canEdit"
          >To edit the <b>coordinates</b> you need to be an
          <span class="underline cursor-pointer" @click="applyEditor = true"
            >editor</span
          >. Now you can only add and edit <b>visa types</b> and the
          <b>description</b></q-banner
        >
      ...
      <q-card-section>
        ...
        <q-list bordered class="bg-white">
          ...
          <div
            v-for="(visa, visaKey) in (data.visas?data.visas:payloadData.visas)"
            :key="visaKey"
          >
            <q-item>
              ...
              <q-item-section class="col-1">
                <q-btn
                  v-if="admin || roleEditor || data.user_created === myUserId"
                  icon="edit"
                  flat
                  dense
                  size="sm"
                  @click="editVisaMethod(visaKey)"
                />
              </q-item-section>
            </q-item>
            <q-separator />
      ...
      <q-card-section>
        <div class="q-gutter-sm">
          ...
          <q-banner rounded class="bg-orange-2 text-orange-10"
            >All logged in users can edit the description, but please make sure
            to follow our
    ...
    <q-dialog v-model="editVisaType">
      <q-card class="no-padding" style="width: 100%; max-width: 350px;">
        ...
        <q-form
          @submit.prevent="saveEditVisaType"
          class="q-gutter-sm full-width"
        >
