    ...
    <q-form @submit.prevent.stop="submitMarker()" ref="myForm">
      <q-card-section class="q-gutter-md">
        ...
        <div v-if="payload.country1.country">
          ...
          <q-select
            :options="
              Object.keys(allCountryData[payload.country1.country].borders_new)
            "
            v-model="payload.country2.country"
            filled
