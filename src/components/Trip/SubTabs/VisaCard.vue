<template>
  <div class="q-gutter-y-sm border">
    ...
    <div v-if="itemData.onlineVisa" class="q-gutter-y-sm">
      ...
      <div v-if="itemData.onlineVisa">
        <b>Website: </b>
        <a :href="itemData.website" target="_blank">{{ itemData.website }}</a>
      </div>
    </div>
    ...
    <div v-if="!itemData.onlineVisa" class="q-gutter-y-sm">
      ...
      <div>
        You can apply for the visa of <b>{{ countryKey }}</b> in
        <b>{{ itemData.country_located }}, {{ itemData.city }}</b>
      </div>
    </div>
    ...
    <div v-if="itemData.visas">
      ...
      <div v-for="(visa, visaKey) in itemData.visas" :key="visaKey">
        <div class="q-ml-sm">
          {{ visa.title }} - {{ visa.leng }} - {{ visa.costs }}
        </div>
      </div>
    </div>
