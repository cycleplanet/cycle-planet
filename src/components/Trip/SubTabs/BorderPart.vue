  ...
  <div v-if="Object.keys(mySelectedCountriesComputed).length>1">
    <div v-for="(country, index) in mySelectedCountriesComputed" :key="index">
            <div v-if="index>0" class="q-my-md spacing">
              ...
              <div v-if="allCountryData[mySelectedCountriesComputed[index-1]].schengen&&allCountryData[mySelectedCountriesComputed[index]].schengen">
                Both countries are part of the Schengen Area, thus there are open borders.
              </div>
              <div v-if="!allCountryData[mySelectedCountriesComputed[index-1]].borders_new?true:false">
                  ...
                  <div v-for="(borderItem, borderItemKey) in borderData" :key="borderItemKey">
                    <div class="q-mt-sm border" style="padding:8px" clickable v-if="(borderItem.country1.country===mySelectedCountriesComputed[index-1]||borderItem.country1.country===mySelectedCountriesComputed[index])&&(borderItem.country2.country===mySelectedCountriesComputed[index-1]||borderItem.country2.country===mySelectedCountriesComputed[index])">
                      <div class="row">
                        ...
                        <q-space></q-space>
                        <add-button :refKey="'Border_item'" :itemKey="borderItemKey"/>
                        </div>
...
export default {
    ...
    components: {
    	'item-dialog-border': require('components/Country/Modals/ItemDialogBorder.vue').default,
    ...
    methods:{
      ...
      addToMapMethod(borderItemKey){
        this.setItemAction({
          ...
          path:'Users/'+this.userId+'/trips/'+this.tripId+'/markers/'+borderItemKey
        })
      },
