  ...
  <div>
    <div v-for="(country, index) in mySelectedCountriesComputed" :key="index">
      <div v-if="index > 0" class="q-my-md spacing">
        ...
        <div
          v-if="
            !allCountryData[mySelectedCountriesComputed[index - 1]].borders_new
              ? true
              : false
          "
        >
          {{ mySelectedCountriesComputed[index - 1] }} doesn't have landborders,
          so you need to enter this country by airplane or boat.
        </div>
