<template>
  <div>
    <q-card  :style="screenwidthbig?'width: 350px':'width: 240px'" class="q-mr-md bg-grey-1 no-padding">
        <card-header :postItemData="postItemData"/>

        <div v-if="postItemData.refKey==='Video'" >
            <video-embed :class="screenwidthbig?'big':'small'" :src="postItemData.link" sandbox="allow-popups allow-scripts"/>
        </div>
