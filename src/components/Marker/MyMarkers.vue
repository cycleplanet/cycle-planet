        ...
        <div v-for="(marker, itemKey) in userMarkerData" :key="itemKey">
          ...
          >
              ...
              <q-item-section>
                <div class="row">
                  ...
                  {{
                    " (" +
                    (marker.checked_by
                      ? Object.keys(marker.checked_by).length
                      : 0) +
                    "/3)"
                  }}
                </div>
            ...
            <div class="bg-white text-black q-pa-sm">
              <div>
                <b>Status: </b
                >{{ marker.status ? marker.status : "Pending (but visible)" }}
              </div>
              <div v-if="marker.countryKey" class="row items-center">
                <b>Country:</b>
                <modal-countrychip2
              ...
              <q-btn :style="buttonStyle" @click="openItem(marker)"
                >See more</q-btn
              >
            </div>
          </q-expansion-item>
