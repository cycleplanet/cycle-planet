<template>
    <div>
        <q-btn-dropdown split push text-color="white" color="secondary" no-caps icon="fas fa-filter" label="Filter" :size="screenwidthbig?'md':'sm'">
            <q-list>
                ...
                <div v-if="markerlist['Available for hosting'].active">
                    ...
                    <div v-for="(marker,markerId,index) in usermarkeroptions" :key="index">
                        <q-item>
                            <q-item-section avatar>
                                <q-avatar size="40px">
