...
<q-card class="no-padding">
    ...
    <div class="q-pa-md">
        <a class="text-subtitle1 text-red" :href="url" target="_blank">{{url}}</a>
        <div class="row justify-center text-subtitle1 q-my-sm">
            <button label="copy" class="q-mr-sm"
            v-clipboard:copy="url"
            v-clipboard:success="onCopy"
            v-clipboard:error="onError"
            >copy</button> or share on
        </div>
...
import { Facebook, Twitter, WhatsApp ,Email,Reddit  } from 'vue-socialmedia-share';
import Vue from 'vue'
