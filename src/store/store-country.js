...
const state = {
	refsextra:{
		...
		'About':{title:'About', type:'single' ,description:'This section should only contain about 5 lines, briefly explaining the highlights of the country, and how good this country is accessible by bicycle.'},
		'Corona':{title:'Corona', type:'single',description:'What are the regulations of this country for corona? Are landborders open or closed? Do you need a test?'},
		'QuickFacts':{title:'Quick Facts',type:'summarylist', summarylist:true, description:'In just a few words (not a few lines!) describe the items.', items:{
		...
		'People':{title:'People', type:'single' ,description:'How are the people of this country? Do they like cylists? Are there any habits others should know about? Are there more than one spoken languages?'  },
		'Route':{title:'Routes',postlist:true,  type:'postlist'  },
		'Visa':{title:'Visa',  type:'single', description:'Is there a visa required for this country, and for which nationalities. Normally you can find reliable information about visa policy on Wikipedia. If there are specific requirements, you can describe them here. More information about a specific embassy should be added as a Visa marker. If there is an online visa, you can mention it here, but please add a Visa marker as well and select the option for online visa.' },
		...
		'Sleeping':{title:'Sleeping',type:'summarylist', summarylist:true, items:{
			'body_cs_ws':{title:'Staying with locals', description:'Is it easy to stay with locals? How is the hosting community?'  },
			'body_formal_camping':{title:'(Formal) Camping',description:'Are there many official campsites? And what is typical on most campsites in these countries? Formal camping means you can camp at public places for free, like schools or chruches. How easy is it to camp formally?'  },
			'body_hostels':{title:'Ho(s)tels', description:'Are there things to take into account when trying to find ho(s)tels? Basically any accomodation that you need to pay for could be mentioned here.' },
			'body_wildcamping':{title:'Wildcamping',description:'Is it legal to do wild camping? Is it easy to find spots? Are there any things you need to take into account when someone want to camp in the wild?'  },
		} },
		'Safety':{title:'Safety',type:'summarylist', summarylist:true, items:{
			'body':{title:'General', description:'Just briefly describes the general safety of the country.' },
			'body_traffic':{title:'Traffic',  description:'How`s the traffic? Is it dangerous for cyclists to be on certain roads?'},
			// 'body_criminality':{title:'Criminality',  },
			// 'body_corruption':{title:'Corruption',  },
			'body_nature':{title:'Nature and animals', description:'Are there any dangers when it comes to nature, such as temperatures, floods, hurricanes? And for which animals should be watched out?' },
		} },
		'Transport':{title:'Transport',type:'summarylist', summarylist:true, items:{
			'body_airplane':{title:'Airplane', description:'Especially for islands it would be nice to know what are the best connections from the nearby mainland. For non-islands, you don`t have to mention all connections, but only name a few if there are only less options. You can also mention internal flights, and if it is easy to take a bicycle on the plane.' },
			'body_train':{title:'Train', description:'Could you bring the bicycle inside the national trains?' },
			'body_bus':{title:'Bus',  description:'Could you bring the bicycle inside the national busses?'},
			'body_boat':{title:'Boat', description:'What are the important ferry connections? And could you bring a bicycle on it?' },
		} },
		'FoodDrink':{title:'Food and Drink', type:'single', description:'What does the local kitchen offers? And where can you find which kind of food (supermarkets, stalls on the street, restaurants)? How can you get drinkable water?' },
		'Health':{title:'Vaccinations & health', type:'single', description:'Which vaccinations are required, and which are recommended? Are there any other health related things to take into account when traveling this country?'  },
		'Blog':{title:'Blogs',postlist:true,  type:'postlist'  },
		'Video':{title:'Video',postlist:true,  type:'postlist'  },
		'Other':{title:'Other',  type:'single' , description:'Basically, if you want to share something that doesn`t fit in one of the above sections, you can write it down here. For example: Best time to cycle, spare parts, nice routes (preferably make a gpx and add it as a gpx post), tips.' },
