...
const state = {
  ...
  whatsappgroups: {
    africa1: {
      name: "West Africa",
      link: "https://chat.whatsapp.com/GWfNH4Jk7nnJzSF1ZJBghO",
    },
    africa2: {
      name: "East Africa",
      link: "https://chat.whatsapp.com/Ks1O8OSBaoFAxgzmJsXEQX",
    },
    middleEast: {
      name: "Middle East",
      link: "https://chat.whatsapp.com/KlmFjR8cbEl2oTqxBjAvm1",
    },
    cnAsia: {
      name: "Central & North Asia",
      link: "https://chat.whatsapp.com/KFPOAcBzNd9LnLHBpEf0S5",
    },
    seAsia: {
      name: "South East Asia",
      link: "https://chat.whatsapp.com/KSnACNW1N2gJzyCg34volO",
    },
    oceania: {
      name: "Oceania",
      link: "https://chat.whatsapp.com/KuTZdaERWYk9x7SErsQMJr",
    },
    nAmerica: {
      name: "North America",
      link: "https://chat.whatsapp.com/LZY4a9oPVu3Jr8bRbV1yqy",
    },
    sAmerica: {
      name: "South America",
      link: "https://chat.whatsapp.com/Km3UpBk5Cvc66GarXoaFlm",
    },
    europe: {
      name: "Europe",
      link: "https://chat.whatsapp.com/ITxb9OzZHBhGHNCXK9wK3r",
    },
  },
  ...
  continentAdapter: {
    ...
    Caribbean: {
      ...
      whatsappgroups: ["nAmerica", "sAmerica"],
    },
    "Central America": {
      continent: "North America",
      whatsappgroups: ["nAmerica", "sAmerica"],
    ...
    "Northern America": {
      continent: "North America",
      whatsappgroups: ["nAmerica"],
    },
    "South America": {
      continent: "South America",
      whatsappgroups: ["sAmerica"],
    },
    ...
    "Middle Africa": {
      continent: "Africa",
      whatsappgroups: ["africa1", "africa2"],
    },
    "Northern Africa": {
      continent: "Africa",
      whatsappgroups: ["africa1", "africa2"],
...
const mutations = {
  ...
  updateCountry(state, payload) {
    Object.assign(
      state.allCountryData[payload.countryKey],
...
const getters = {
  countriesFiltered: (state, getters) => {
    ...
    const matchingCountries = Object.entries(
      countryConstants
