              ...
              <div v-if="section.list">
                <div v-if="item.apple ? isWebApp : true">
                  <q-item
                    ...
                    @click="
                      section.name === 'Mobile apps'
                        ? mobileAppDialog(item.title)
                        : ''
                    "
                  >
                    <q-item-section avatar>
                    ...
                    <q-item-section v-if="section.list">{{
                      item.title
                    }}</q-item-section>
                  </q-item>
                </div>
...
export default {
          ...
          items: [
            {
              title: "Facebook",
              icon: "",
              img: "social_icons/icon_facebook.png",
              url: "https://www.facebook.com/Cycle-Planet-100672311813208",
            },
            {
              title: "Instagram",
              icon: "",
              img: "social_icons/icon_instagram.png",
              url: "https://www.instagram.com/cycle.planet",
            },
          ],
        },
        {
  ...
  methods: {
    ...
    android() {
      window.open(
        "https://play.google.com/store/apps/details?id=com.cycleplanet.cycleplanet",
        "_blank"
      );
    },
    apple() {
      window.open(
        "https://apps.apple.com/app/cycle-planet/id1547132334",
        "_blank"
      );
    },
  },
