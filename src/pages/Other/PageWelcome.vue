  ...
  <div class="bg-grey-3">
    ...
    <div class="imageclass image1 flex items-end" style="min-height: 100vh;">
      <div class="constrain" style="width: 100%;">
        <div class="text-white">
          <div class="text-h2 textblock1">
            Your bicycle touring adventure starts here
          </div>
        </div>
    ...
    <div class="constrain2" style="margin-top: -100px;">
      <div class="row justify-center">
        <div
          v-for="card in cards"
          class="col-4 col-md-3 col-sm-5 col-xs-12 card text-center"
        >
          <div class="cardicon">
    ...
    <q-dialog v-model="feedbackDialog">
      <q-card style="min-width: 350px;">
        ...
        <q-card-section>
          <div class="">
            Please tell us what is on your mind. Try to describe the feedback as
        ...
        <q-card-section class="q-pt-none">
          <q-input
            ...
            dense
            v-model="feedback"
            @keyup.enter="sendFeedbackMethod"
          />
        </q-card-section>
...
export default {
  ...
  data() {
    return {
      ...
      cards: [
        {
          title: "Get hosted for free",
          description:
            "In the map you can find hosts, and you can send chat messages to them. This allows you to get hosted during your trip for free. ",
          image: "eva-home-outline",
        },
        {
          title: "Fully interactive map",
          description:
            "With the fully interactive map you can find border crossings, embassies, activities, other users and much more",
          image: "eva-map-outline",
        },
        {
          title: "Plan your next trip",
          description:
            "Create a general route through the countries you want to cycle, and find the latests information about those pages on a single page.",
          image: "eva-globe-2-outline",
        },
        {
          title: "Information about all countries",
          description:
            "Every country has it`s page with only the most useful information for bicycle tourists.",
          image: "eva-info-outline",
        },
        {
          title: "Contribute to the community",
          description:
            "Every user can add new markers and country information, or edit existing information. This way, you can contribute to the tourbiking community",
          image: "eva-cloud-upload-outline",
        },
        {
          title: "Create your own profile",
          description:
            "With your own profile you can easily show others all the bike related information you have.",
          image: "eva-person-add-outline",
        },
      ],
    };
  },
