  ...
  <div>
    <div class="q-pa-md">
      <div class="q-pa-md">
        ...
        <p class="text-body1">
          Cycle Planet is run by volunteers, and is happy to see other people
          joining the team to help improving and growing the community. Please
          contact Cycle Planet if you have interests in joining.
        </p>
        <div class="row"></div>
    ...
    return {
      ...
      persons: {
        bas: {
          ...
          image:
            "https://firebasestorage.googleapis.com/v0/b/cycle-planet-292f5.appspot.com/o/users%2FieMGYdJeX6ZyKgKeeGhMXPFZkax2%2Fb3dd33d5-136a-4f37-bd7c-b74020df6d51?alt=media&token=4dab1517-e479-4c2a-a961-49a35ef1a5c6",
          description:
            "Relatively fresh in the bike touring world, Bas started cycling in 2019 in Europe and Africa. During this trip he found the idea of creating the Cycle Planet platform, and during the Corona epidemic he started building it.",
