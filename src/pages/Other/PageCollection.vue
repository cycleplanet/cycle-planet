    ...
    <q-card v-for="person in persons" :key="person" class="q-mr-md q-mb-md" style="max-width:287px; height:100%" flat bordered>
      ...
      <q-item class="q-pl-none" style="margin-top:100px">
        ...
        <q-item-section side top>
              <q-btn round size="sm" :style="buttonStyle" icon="add"  @click.native="AddPostMethod('Route')"/>
        </q-item-section>
      </q-item>

    <div>
        <q-virtual-scroll v-if="routePostsSorted" :items="[0]" virtual-scroll-horizontal>
            <div  class="row no-wrap">
      ...
      <q-item class="q-pl-none" style="margin-top:100px">
        ...
        <q-item-section side top>
          <q-btn round size="sm" :style="buttonStyle" icon="add"  @click.native="AddPostMethod('Video')"/>
        </q-item-section>
      </q-item>
    <div>
        <q-virtual-scroll v-if="videoPostsSorted" :items="[0]" virtual-scroll-horizontal>
            <div  class="row no-wrap">
     ...
     <q-item class="q-pl-none" style="margin-top:100px">
        ...
        <q-item-section side top>
          <q-btn round size="sm" :style="buttonStyle" icon="add"  @click.native="AddPostMethod('Blog')"/>
        </q-item-section>
      </q-item>
    <div>
      <!-- {{blogPostsSorted}} -->
        <q-virtual-scroll v-if="blogPostsSorted" :items="[0]" virtual-scroll-horizontal>
            <div  class="row no-wrap">
...
export default {
  ...
  data(){
      return{
          ...
          'blanca':{
            ...
            image:'http://www.blancaonabike.com/wp-content/uploads/2015/04/PSX_20170409_201741.jpg',
  ...
  computed:{
    ...mapGetters('post', ['routePostsSorted','videoPostsSorted','blogPostsSorted']),    
