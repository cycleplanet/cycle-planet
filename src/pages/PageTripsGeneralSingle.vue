      ...
      <q-card>
        <div class="q-pa-md q-gutter-y-sm">
          <div class="row q-mb-lg">
            <div :class="isWebApp ? 'text-h3' : 'text-h4'">
              {{ tripDetails.title }}
            </div>
            ...
            <q-btn
              ...
              :style="buttonStyle"
              @click="loggedIn ? addToMyTrip() : showLoginDialog()"
            />
          </div>
          ...
          <div class="row">
            <div
              v-for="(country, countryKey) in tripDetails.countries"
              :key="countryKey"
            >
              <modal-countrychip3
                :countryKey="country"
    ...
    <div>
      ...
      <q-tab-panels v-model="tab" animated>
        <q-tab-panel name="borders">
          <border-part-general
            :mySelectedCountriesComputed="mySelectedCountriesComputed"
          />
        </q-tab-panel>
...
export default {
  ...
  components: {
    ...
    "tab-information": require("components/Trip/Tabs/TabInformation.vue")
      .default,
    "tab-planner": require("components/Trip/Tabs/TabPlanner.vue").default,
    "border-part-general": require("components/Trip/SubTabs/BorderPartGeneral.vue")
      .default,
    "visa-part": require("components/Trip/SubTabs/VisaPart.vue").default,
    "activity-part": require("components/Trip/SubTabs/ActivityPart.vue")
      .default,
    ...
    return {
      ...
      tripsData: {
        "cairo-capetown": {
          ...
          image:
            "https://cdn.pixabay.com/photo/2018/03/17/10/05/wildlife-3233525_960_720.jpg",
          summary:
        ...
        "alaska-patagonia": {
          ...
          image:
            "https://cdn.pixabay.com/photo/2020/09/17/12/44/landscape-5579077_960_720.jpg",
          summary:
        ...
        "istanbul-singapore": {
          ...
          image:
            "https://cdn.pixabay.com/photo/2017/06/13/19/31/samarkand-2399796_960_720.jpg",
          summary:
        ...
        "tanger-capetown": {
          ...
          image:
            "https://firebasestorage.googleapis.com/v0/b/cycle-planet-292f5.appspot.com/o/Admin%2FTrips%2F20190803110224_IMG_0810-01.jpeg?alt=media&token=750d7e91-7cc6-4479-aeac-e93fc404107d",
          summary:
            "Probably not the easiest route for beginners, but definetly one with character. Meet the incredible hospitality that one of the poorest regions in the world has to offer you.",
  ...
  computed: {
    ...
    mySelectedCountriesComputed() {
      if (this.tripsData[this.$route.params.tripId]) {
        this.mySelectedCountries = this.tripsData[
    ...
    addToMyTrip() {
      this.$q
        .dialog({
          title: "Confirm",
          message:
            "Are you sure you want to add this trip to your profile? It will create a new trip on your profile with the settings of this template. You can change the information of this trip in the settings later. ",
          cancel: true,
        })
        .onOk(() => {
          this.setItemAction({
          ...
          setTimeout(() => {
            this.$q.notify({
              message:
                "We created a new trip on your profile. You can adjust the information in the settings.",
              color: "secondary",
            });
          }, 3000);
